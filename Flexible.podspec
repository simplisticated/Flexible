#
#  Be sure to run `pod spec lint Flexible.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Flexible"
  s.version      = "1.0"
  s.summary      = "Smart arrays implemented in Swift"
  ...
  s.description  = <<-DESC
Provides developer with set of tools that simplify work with arrays in Swift.
                   DESC
  ...
  s.source       = { :git => "https://github.com/igormatyushkin014/Flexible.git", :tag => s.version }
